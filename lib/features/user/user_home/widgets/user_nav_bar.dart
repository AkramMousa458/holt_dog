...
class UserNavBar extends StatelessWidget {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                _buildNavItem(0, Icons.camera_alt, 'Scan', 15.h),
                _buildNavItem(1, Icons.home, 'Home', 40.h),
                _buildNavItem(2, Icons.room, 'Map', 15.h),
              ],
            ),
          ),
        ],
  ...
  Widget _buildNavItem(int index, IconData icon, String label, double bottomMargin) {
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              child: Icon(
                icon,
                color: isSelected ? AppColors.primaryPurple : AppColors.primaryPurple.withOpacity(0.7),
