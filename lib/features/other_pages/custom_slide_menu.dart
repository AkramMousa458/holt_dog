...
class CustomSlideMenu extends StatefulWidget {
  const CustomSlideMenu({super.key});

  @override
  State<CustomSlideMenu> createState() => _CustomSlideMenuState();
}

class _CustomSlideMenuState extends State<CustomSlideMenu> {
          ...
          children: [
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  Text('Nour Ashraf', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                  Text('nour@mail.com', style: TextStyle(color: Colors.white70, fontSize: 12)),
                ],
              ),
            ),
            const Icon(Icons.keyboard_double_arrow_left, color: Colors.white, size: 30),
          ],
        ),
      ),
    );
  ...
  Widget _buildMenuItem({required IconData icon, required String title, required VoidCallback onTap, Color iconColor = Colors.white, Widget? trailing}) {
    return Padding(
        ...
        children: [
            ...
            child: SafeArea(
              child: Stack(
                children: [
                  ...
                  const Center(
                    child: Text('Feedback', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ),
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  const Icon(Icons.favorite, size: 80, color: Color(0xFF4A148C)),
                  const Text('Holt_Dog', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF4A148C))),
                  const Text('Every Stray Deserves a Story', style: TextStyle(fontSize: 12)),
                  const SizedBox(height: 40),
                  const Align(alignment: Alignment.centerLeft, child: Text('How Was Our Service ?', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600))),
                  ...
                  Row(
                    ...
                    children: List.generate(5, (index) {
                      return IconButton(
                        ...
                        icon: Icon(index < _rating ? Icons.star : Icons.star_border, size: 45, color: const Color(0xFF4A148C)),
                      );
                    }),
                  ),
                  const SizedBox(height: 30),
                  const Align(alignment: Alignment.centerLeft, child: Text('Comment', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600))),
                  ...
                  ConstrainedBox(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const FeedbackSuccessPage()));
                        },
              ...
              children: [
                ...
                RichText(
                  ...
                  text: const TextSpan(
                    ...
                    children: [
                      TextSpan(text: 'Thank you! ', style: TextStyle(fontWeight: FontWeight.bold)),
        ...
        child: Column(
          children: [
            Stack(
              ...
              children: [
                ClipPath(clipper: HeaderClipper(), child: Container(height: 180, width: double.infinity, color: primary)),
                SafeArea(
                  child: Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Row(
                      ...
                      children: [
                        CircleAvatar(backgroundColor: Colors.white, child: IconButton(icon: const Icon(Icons.arrow_back_ios_new, color: primary, size: 18), onPressed: () => Navigator.pop(context))),
                ...
                Positioned(
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(radius: 50, backgroundColor: Colors.grey[300], child: const Icon(Icons.person, size: 60, color: Colors.white)),
                      const Positioned(bottom: 0, right: 0, child: CircleAvatar(radius: 18, backgroundColor: primary, child: Icon(Icons.camera_alt, size: 16, color: Colors.white))),
                    ],
                  ),
                ),
              ],
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 50,
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: primary, foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30))),
                      onPressed: () {},
...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      body: Column(
        children: [
          Stack(
            ...
            alignment: Alignment.topCenter,
            children: [
              ClipPath(clipper: HeaderClipper(), child: Container(height: 180, width: double.infinity, color: const Color(0xFF4A148C))),
              SafeArea(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Row(
                    children: [
                      CircleAvatar(backgroundColor: Colors.white, child: IconButton(icon: const Icon(Icons.arrow_back_ios_new, color: Color(0xFF4A148C), size: 18), onPressed: () => Navigator.pop(context))),
                      const Expanded(child: Center(child: Text('Settings & Privacy', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)))),
                      const SizedBox(width: 40),
                    ],
                  ),
                ),
              ),
              Positioned(bottom: -40, child: CircleAvatar(radius: 50, backgroundColor: Colors.grey[300], child: const Icon(Icons.miscellaneous_services, size: 60, color: Colors.white))),
            ],
          ),
          const SizedBox(height: 70),
          _buildToggle('Camera', _cameraEnabled, (v) => setState(() => _cameraEnabled = v)),
          _buildToggle('Location', _locationEnabled, (v) => setState(() => _locationEnabled = v)),
        ],
      ),
    );
  }
  ...
  Widget _buildToggle(String title, bool val, ValueChanged<bool> onChange) {
    return ListTile(title: Text(title, style: const TextStyle(fontWeight: FontWeight.bold)), trailing: CupertinoSwitch(value: val, onChanged: onChange));
  }
}
...
class ContactUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned(bottom: 0, right: 0, child: ClipPath(clipper: BottomRightClipper(), child: Container(width: 150, height: 150, color: primary))),
          SingleChildScrollView(
            child: Column(
              children: [
                ClipPath(clipper: TopDiagonalClipper(), child: Container(height: 200, width: double.infinity, color: primary, child: const Center(child: Icon(Icons.mail_outline, size: 50, color: Colors.white)))),
                Padding(
                  padding: const EdgeInsets.all(24.0),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      const Text('Contact Us', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 20),
                      _field('Name'), _field('Email'), _field('Message', lines: 4),
                      ElevatedButton(
  ...
  Widget _field(String hint, {int lines = 1}) {
    return Container(
      ...
      child: TextField(maxLines: lines, decoration: InputDecoration(hintText: hint, border: InputBorder.none, contentPadding: const EdgeInsets.all(12))),
    );
  }
}
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              backgroundColor: Colors.white,
                              child: IconButton(
                                icon: const Icon(Icons.arrow_back_ios_new, color: primaryPurple, size: 18),
                                onPressed: () => Navigator.pop(context),
                              ),
                            ),
                            const Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _whatWeDoCard(Icons.campaign_outlined, 'Spread\nAwareness', const Color(0xFFEDE7F6)),
                      _whatWeDoCard(Icons.shield_outlined, 'Dog\nProtection', const Color(0xFFFCE4EC)),
                      _whatWeDoCard(Icons.eco_outlined, 'Environmental\nProtection', const Color(0xFFE8F5E9)),
                    ],
                  ),
                ],
              ),
            ...
            child: Container(
              ...
              child: const Column(
                children: [
                  ...
                  SizedBox(height: 8),
                  Text('Holt Dog', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
                  SizedBox(height: 4),
                  Text('Every Stray Deserves a Story', style: TextStyle(color: Colors.white70, fontSize: 13)),
                ],
              ),
            ),
          ),
  ...
  static Widget _sectionTitle(String title, IconData icon) {
    return Row(
      children: [
        ...
        Text(title, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: primaryPurple)),
      ],
    );
  }
  ...
  static Widget _storyCard(String text) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.deepPurple.withOpacity(0.08), blurRadius: 16, offset: const Offset(0, 6))],
        border: Border.all(color: const Color(0xFFEDE7F6), width: 1.5),
      ),
      child: Text(text, style: const TextStyle(fontSize: 15, color: Colors.black87, height: 1.75)),
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(label, textAlign: TextAlign.center, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: primaryPurple, height: 1.4)),
          ],
        ),
      ),
    );
  ...
  static Widget _missionCard() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Row(children: [Icon(Icons.format_quote, color: Colors.white54, size: 30)]),
          const SizedBox(height: 8),
          const Text(
            ...
            child: Container(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 6),
                  Text('Holt_Dog', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ),
