            ...
            children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: AppTypography.caption.copyWith(
                          color: AppColors.textOnPurple.withOpacity(0.9),
                          fontSize: 14.sp,
                        ),
                      ),
                      Icon(Icons.keyboard_arrow_down, color: AppColors.textOnPurple.withOpacity(0.9), size: 20.w),
                    ],
                  ),
                  SizedBox(height: 4.h),
                  Text(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors.backgroundWhite.withOpacity(0.3), width: 1.5),
                ),
                child: Row(
                  children: [
                    Text(
...
class QuoteBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.backgroundGray.withOpacity(0.8),
        borderRadius: BorderRadius.circular(AppStyles.radiusL.r),
        border: Border.all(color: AppColors.borderLight.withOpacity(0.5)),
      ),
      child: Column(
